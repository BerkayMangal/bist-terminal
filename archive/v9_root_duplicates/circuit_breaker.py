...
from config import (
    ...
    CB_EODHD_FAILURE_THRESHOLD,
    CB_EODHD_RECOVERY_TIMEOUT,
...
cb_eodhd = CircuitBreaker(
    name="eodhd",
    failure_threshold=CB_EODHD_FAILURE_THRESHOLD,
    recovery_timeout=CB_EODHD_RECOVERY_TIMEOUT,
)
